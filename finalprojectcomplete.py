...
# now = strftime("Can you hear me, Batman? I know you can. Yes, it is I, Edward Nigma, The Riddler and more importantly your intellectual superior. My genius has allowed me to easily hack into your primitive communications. My goal is simple! You complete a series of amusingly taxing challenges and, well, you'll see. Ready for your first one?")
# 
# #make image bigger
# root=Tk()
...
# 
# output = " %s Great, now it's time to take the riddler down! (close the picture to view note)" %name
# 
...
# 
# 
# Label(root, text = "Have you really decided to try and take me on? Get to it, then! \n I'm looking forward to watching you \n fail. Fiddle diddle diddle, time for a riddle… lets begin.").place(x=5, y=5)
# root.mainloop()
# time.sleep(1)
#     
# 
...
# 
# nameb = tkinter.simpledialog.askstring("??", "Riddle: I can be cracked. I can be made. I can be told. I can be played. What am I?" )
# 
...
#         root2 = Tk()
#         root2.title("Main")
#         root2.geometry("410x200")
#         global e1
#         global e2
#         Label(root2, text = "Well, well, well, you cracked my first riddle. \n Don’t get too full of yourself, Dark Knight. \n It only gets harder from here. \n With this task I need you to use all \n your supposed bat strength to press a sensor. \n I chose a certain number that you must reach \n below but only if you are strong enough will \n you be able to reach it. Enjoy it while it lasts, Dark Knight.\n  I have more in store for you than simply brutalizing \n things.").place(x=5, y=5)
#         C = 0
#     
# 
# root2.mainloop()
...
# #         root3 = Tk()
# #         root3.title("Main")
# #         root3.geometry("410x200")
# #         global e1
# #         global e2
# # 
# # 
# #         Label(root3, text = " You are performing just below my predicted expectations. \n At this rate you'll never beat me! \n I have another good riddle I think you’ll particularly like.").place(x=5, y=5)
# #         root3.mainloop()
# #         time.sleep(1)
# #         quit()
# #     return count
...
root15=Tk()
root15.title("BATMAN VS THE RIDDLER")
canvas= Canvas(root15, width = 350, height=250)
canvas.pack()
#CAN ADD A DIFFERENT PICTURE BELOW IF WANT
photo=PhotoImage(file='riddler.gif') 
canvas.create_image(0, 0, anchor = NW, image=photo)
...
namea = tkinter.simpledialog.askstring("??", "Riddle: What does a liar do when he’s dead?")

# try creating new root names for each pop up and then closing them for the next one to be created
M = 3
while (M > 0):
    if (namea != "He lies still"):
        if(M == 0):
            break
        else:
            print(M, "more trys")
            ...
            namea = tkinter.simpledialog.askstring("??", "Riddle: What does a liar do when he’s dead?" )
            #DETERMINE WHAT WILL HAPPEN IF C RUNS OUT
    elif(namea == "He lies still"):
        root15 = Tk()
        root15.title("Main")
        root15.geometry("420x200")
        global e1
        global e2
        Label(root15, text = "That one could have been solved by a monkey. \n But good job, nevertheless. This next riddle has been calibrated \n to offer a challenge comparable to a popular child's game.\n  I call it: Riddler Says. The rules are simple. \n  Hit the switches that match the colors you see, \n in order in which you see them. Easy! Enjoy! ").place(x=5, y=5)
        M = 0
...
#         plau = sleep(1)
        ...
        if(DEBUG):
            ...
            if (len(seq) >= 5):
                 root4 = Tk()
                 root4.title("Main")
                 root4.geometry("420x200")
                 global e1
                 global e2


                 Label(root4, text = "Do you have a photographic memory, Batman? \n Because I do. I can summon your sneering features \n at will. That is, when they don't burst unbidden \n into my brain. Lets step it up and make you \n think a little more! ").place(x=5, y=5)
                 root4.mainloop()
                 time.sleep(1)
                 print ("Riddle Completed")
                 break
...
nameq = tkinter.simpledialog.askstring("??", "Riddle: What is found in every corner and two in every room?" )

# try creating new root names for each pop up and then closing them for the next one to be created
Z = 3
while (Z > 0):
    if (nameq != "The letter O"):
        if(Z == 0):
            break
        else:
            print(Z, "more trys")
            ...
            nameq = tkinter.simpledialog.askstring("??", "Riddle: What is found in every corner and two in every room?" )
            #DETERMINE WHAT WILL HAPPEN IF C RUNS OUT
    elif(nameq == "The letter O"):
        root9 = Tk()
        root9.title("Main")
        root9.geometry("400x200")
        global e1
        global e2
        Label(root9, text = "For this next challenge I want you to guess \n the distance of an object. Easy enough? \n Let’s give it a whirl.").place(x=5, y=5)
        Z = 0
...
root5 = Tk()
root5.title("Main")
root5.geometry("420x200")
global e1
global e2


Label(root5, text = " What! No. This is not happening. \n Did you cheat? Of course, you did, it's the only way. \n It doesnt matter, you might of solved my riddles but \n you will never find out my hiding spot, \n HAHAHA ").place(x=5, y=5)
root5.mainloop()
#time.sleep(1)
GPIO.cleanup()
...
class GuessingGame:
    def __init__(self, master):
        self.master = master
        master.title("SEVENTH RIDDLE")

        self.secret_number = random.randint(1, 50)
        self.guess = None
        self.num_guesses = 0

        self.message = "OH NO, The riddler got away. The only way to find \n him is to guess what building he went into! \n Quick, the apartment numbers range from 1-50! "
    ...
    def guess_number(self):
        ...
        if self.guess is None:
            ...
            self.message = "Finally you found the riddler! It only took you %d guess%s." % (self.num_guesses, suffix)
    ...
    def quit_game(self):
        root5 = Tk()
        root5.title("Main")
        root5.geometry("450x200")
        global e1
        global e2
        root.destroy()

        Label(root5, text = " Wow you actually found me?? \n HAHAHA doesnt matter. You will never figure out \n how to get into my room.").place(x=5, y=5)
        root5.mainloop()
        time.sleep(1)
        GPIO.cleanup()
        sys.exit()
...
# play the game
    def play(self):
        ...
        self.setupGUI()
        self.setRoomImage()
        self.setStatus("TRY FINDING ME BATMAN!")
